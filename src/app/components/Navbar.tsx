  ...
  <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-center w-full sm:w-auto mt-4 sm:mt-0">
    ...
    {adminName && (
      <div className="relative w-full sm:w-auto" ref={adminDropdownRef}>
        ...
        {isAdminDropdownOpen && (
          <div className="absolute top-full left-1/2 -translate-x-1/2 bg-white border rounded shadow-lg text-blue-600 font-bold text-[1.2rem] flex flex-col w-64 z-50">
